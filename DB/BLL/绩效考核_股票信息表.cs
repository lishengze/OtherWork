...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.绩效考核_股票信息表 dal=new Maticsoft.DAL.绩效考核_股票信息表();
		public 绩效考核_股票信息表()
		{}
		#region  Method
		/// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.绩效考核_股票信息表> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.绩效考核_股票信息表> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.绩效考核_股票信息表> modelList = new List<Maticsoft.Model.绩效考核_股票信息表>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.绩效考核_股票信息表 model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Maticsoft.Model.绩效考核_股票信息表();
