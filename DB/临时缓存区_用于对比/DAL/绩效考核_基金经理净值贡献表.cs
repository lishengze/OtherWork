...
namespace Maticsoft.DAL
{
	...
	public partial class 临时缓存区_绩效考核_基金经理净值贡献表
	{
		...
		public bool Exists(string 基金经理,string 时间,string 基金产品)
		{
			...
			strSql.Append("select count(1) from 临时缓存区_绩效考核_基金经理净值贡献表");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into 临时缓存区_绩效考核_基金经理净值贡献表(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update 临时缓存区_绩效考核_基金经理净值贡献表 set ");
		...
		public bool Delete(string 基金经理,string 时间,string 基金产品)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from 临时缓存区_绩效考核_基金经理净值贡献表 ");
			strSql.Append(" where 基金经理=@基金经理 and 时间=@时间 and 基金产品=@基金产品 ");
			SqlParameter[] parameters = {
					new SqlParameter("@基金经理", SqlDbType.NVarChar,50),
					new SqlParameter("@时间", SqlDbType.NVarChar,50),
		...
		public Maticsoft.Model.绩效考核_基金经理净值贡献表 GetModel(string 基金经理,string 时间,string 基金产品)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 基金经理,时间,基金产品,本年净值贡献 from 临时缓存区_绩效考核_基金经理净值贡献表 ");
			strSql.Append(" where 基金经理=@基金经理 and 时间=@时间 and 基金产品=@基金产品 ");
			SqlParameter[] parameters = {
					new SqlParameter("@基金经理", SqlDbType.NVarChar,50),
					new SqlParameter("@时间", SqlDbType.NVarChar,50),
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM 临时缓存区_绩效考核_基金经理净值贡献表 ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "临时缓存区_绩效考核_基金经理净值贡献表";
