...
namespace Maticsoft.DAL
{
	...
	public partial class 绩效考核_未上市股票信息表
	{
		...
		public bool Exists(string 股票代码)
		{
			...
			strSql.Append("select count(1) from 绩效考核_未上市股票信息表");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into 绩效考核_未上市股票信息表(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update 绩效考核_未上市股票信息表 set ");
		...
		public bool Delete(string 股票代码)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from 绩效考核_未上市股票信息表 ");
			strSql.Append(" where 股票代码=@股票代码 ");
			SqlParameter[] parameters = {
					new SqlParameter("@股票代码", SqlDbType.VarChar,6)};
			parameters[0].Value = 股票代码;
		...
		public Maticsoft.Model.绩效考核_未上市股票信息表 GetModel(string 股票代码)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 股票代码,股票名称 from 绩效考核_未上市股票信息表 ");
			strSql.Append(" where 股票代码=@股票代码 ");
			SqlParameter[] parameters = {
					new SqlParameter("@股票代码", SqlDbType.VarChar,6)};
			parameters[0].Value = 股票代码;
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM 绩效考核_未上市股票信息表 ");
			if(strWhere.Trim()!="")
			{
